        ...
        <div id="content">
          ...
          <div class="container-fluid">
              ...
              <div class="card-body">
                <form action="/tambah-produk" method="POST" enctype="multipart/form-data">
                  <div class="mb-3 d-flex flex-column">
                    <label for="fotoProdukCrop" class="form-label">Foto Produk (Ukuran 1024x768)</label>
                    <input class="" type="file" name="fotoCrop" id="fotoProdukCrop" required />
                  </div>
                  <div class="mb-3 d-flex flex-column">
                    <label for="fotoProduk" class="form-label">Foto Produk Asli</label>
                    <input class="" type="file" name="foto" id="fotoProduk" required />
                  </div>
                  <div class="mb-3">
                    <label for="namaProduk" class="form-label">Nama Produk</label>
                    <input type="text" class="form-control" name="nama" id="namaProduk" required />
                  </div>
                  <div class="mb-3">
                    <label for="keteranganProduk" class="form-label">Keterangan</label>
                    <textarea class="form-control" name="keterangan" id="keteranganProduk" rows="3" required></textarea>
                  </div>
            ...
            <div class="card shadow">
              <div class="card-header">
                <strong>Produk yang Ditampilkan</strong>
              </div>
              <div class="card-body">
                <div class="row">
                  @foreach ($produk_list as $produk)
                    <div class="col-md-4 mb-4">
                      <div class="card h-100">
                        <img src="{{ asset('produkEmoka/' . $produk->fotoCrop) }}" class="card-img-top" alt="" />
                        <div class="card-body">
